...
const Home = (): JSX.Element => {
  return (
    <div className="h-[89vh] w-full flex flex-col items-start justify-center pl-10 md:pl-40 bg-[linear-gradient(to_right_top,rgba(0,0,0,1),rgba(255,255,255,0.3)),url('https://hips.hearstapps.com/hmg-prod/images/young-strong-sweaty-focused-fit-muscular-man-with-royalty-free-image-1594652842.jpg?resize=1200:*')] bg-cover bg-fixed">
      <div className="flex flex-col h-72 max-w-[500px] justify-around  ">
        ...
        <div className="flex gap-4 md:gap-8 md:mt-10 text-center p-7">
          <Link
            to="/register"
