...
const Home = (): JSX.Element => {
  return (
    <div className="h-[80vh] w-full flex flex-col items-center justify-center bg-hero bg-cover">
      <div className="flex flex-col h-72 max-w-[500px] justify-around items-center bg-white/50">
        ...
        <div className="flex gap-3 items-center text-center">
          ...
          <Link
            to="/about"
            className="border w-48 p-3 font-semibold rounded-md border-black text-black hover:bg-black hover:text-white ease-in-out duration-500">
            Sobre Nosotros
          </Link>
        </div>
      </div>
