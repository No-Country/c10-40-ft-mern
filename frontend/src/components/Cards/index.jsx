...
var Cards = function () {
    return (<div className="grid grid-rows-3 p-6 justify-center gap-5 h-full w-full">
      <div className="flex flex-col md:flex-row w-full gap-5 items-center justify-around">
        {/* Summary */}
        <react_router_dom_1.Link to={'/dashboard/summary'} className="h-full w-full bg-contain bg-no-repeat bg-center text-center rounded-xl bg-white bg-[url('https://play-lh.googleusercontent.com/bHJ1urQPzOdE71NCjb7LcE3al0e_KTelqGU2uaHIKjoHXFqkYyzwARS0MOE4_Lb4ZA')]">
        ...
        {/* Stats */}
        <react_router_dom_1.Link to={'/dashboard/stats'} className="h-full w-full bg-contain bg-no-repeat bg-center text-center rounded-xl bg-white bg-[url('https://i0.wp.com/verderamade.com/wp-content/uploads/2020/12/primary-color.png?fit=1062%2C656&ssl=1')]">
          <div className="bg-black/60 ease-in duration-200 hover:bg-transparent hover:text-transparent rounded-md p-5 h-full text-white">
            <si_1.SiBookmeter size={10}/>
            <p className="text-sm  flex items-center">Workout Tracker</p>
        ...
        {/* Schedule */}
        <react_router_dom_1.Link to={'/dashboard/schedule'} className="h-full w-full bg-contain bg-no-repeat bg-center text-center rounded-xl bg-white bg-[url('https://cdn-icons-png.flaticon.com/512/1869/1869397.png')]">
          <div className="bg-black/60 ease-in duration-200 hover:bg-transparent hover:text-transparent rounded-md p-5 h-full text-white">
            <si_1.SiBookmeter size={10}/>
            <p className="text-sm  flex items-center">Workout Tracker</p>
