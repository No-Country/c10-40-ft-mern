const Charac = (): JSX.Element => {
  return (
    <div className="py-10 flex flex-col items-center justify-center gap-12 px-5">
      ...
      <div className="flex flex-col gap-6 lg:gap-20 lg:flex-row items-center justify-center w-full max-w-screen-xl">
        ...
        <div className="flex flex-col gap-6 text-primary-400 text-lg font-semibold py-8">
